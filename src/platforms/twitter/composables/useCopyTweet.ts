...
import { translateTextItems, waitATick, type TranslationTextItem, toCopyStageError } from "../../../shared/utils";
...
async function extractTweetTexts(articleList: HTMLElement[]): Promise<string> {
  ...
  try {
    return await translateTextItems(textContents, platformState.configBar.translate, TEXT_SEPARATOR);
  } catch (error) {
